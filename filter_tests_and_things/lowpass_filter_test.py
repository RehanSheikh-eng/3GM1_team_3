...
frequency = 5000  # Frequency of the sine wave in Hz
...
input_data = (generate_sine_wave(frequency, amplitude, duration, sampling_rate) + generate_sine_wave(frequency * 2 * random.random(), amplitude/2, duration, sampling_rate))
