...
# Send data
L2S2.data_send(_record_id = "110", _plate_id = "6e0485b5-cd17-4438-aff8-afe0578ed71f", _control_id = "4", _type = 2, _content = 5, _units = "degrees")
...
#     return payload
# 
# payload_test = get_payload_int(field_id, type = 2, content = GPS_longitude, units = "degrees")
# 
# # Send data
